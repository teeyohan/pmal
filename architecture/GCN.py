...
class GCN(AbsArchitecture):
    r"""Hard Parameter Sharing (HPS-GCN).
    ...
    def __init__(self, task_name, encoder_class, decoders, device, **kwargs):
        super(GCN, self).__init__(task_name, encoder_class, decoders, device, **kwargs)
